...
//print_r($estados);
if($tam==1)
echo"<select id='estadot' name='estadot' onChange='ciudad_dependenciat();' style='width:300px' ><option value='0'>Elige tu Estado</option>";
else
echo"<select id='estadot' name='estadot' onChange='ciudad_dependenciat();' style='width:350px' ><option value='0'>Elige tu Estado</option>";
