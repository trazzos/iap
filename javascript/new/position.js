...
{
    $.ajax({
        url : WEB_ROOT+'/ajax/new/position.php',
        type: "POST",
...
{
    var $message = "¿Esta seguro de eliminar este Puesto? Toma en cuenta que podrían perdese muchas asociaciones (Horarios, maestros, etc)";
