...
public function enviarMail()
	{
	    ...
	    $usuario = $this->Util()->DB()->GetRow();
			...
			$body = "Has hecho una solicitud de recuperacion contrase�a <br/> Numero de control:  ".$usuario['controlNumber']." <br/> Password:  ".$usuario['password']." <br/>  <a href='".WEB_ROOT."'>".COMPANY_NAME."</a> ";
			//asunto o tema
