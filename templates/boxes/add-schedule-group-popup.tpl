<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar Horario</div>
		<div id="vtitl"><span title="Titulo">Agregar Horario</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-schedule-group.tpl"}
</div>
