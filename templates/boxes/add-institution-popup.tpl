<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar institution</div>
		<div id="vtitl"><span title="Titulo">Agregar institution</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-institution.tpl"}
</div>
