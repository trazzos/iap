      ...
      <div id="ftitl">
    		<div class="flabel">Asignar Materia</div>
				<div id="vtitl"><span title="Titulo">Asignar Materia</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-group-subject.tpl"}
		</div>