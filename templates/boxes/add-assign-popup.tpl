      ...
      <div id="ftitl">
    		<div class="flabel">Asignar Materia a Docente</div>
				<div id="vtitl"><span title="Titulo">Asignar Materia a Docente</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-assign.tpl"}
		</div>