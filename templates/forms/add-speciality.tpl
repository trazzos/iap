<form id="addSpecialityForm" name="addSpecialityForm" method="post">
<input type="hidden" id="type" name="type" value="saveAddSpeciality"/>
<ul id="sort-box" class="sorts">
  <li>              
    <div class="content-in-popup">
      ...
      <input type="button" class="btn-70-l" id="addSpeciality" name="addSpeciality" />                  
      </div>
