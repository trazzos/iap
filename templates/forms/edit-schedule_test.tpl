<form id="editSchedule_testForm" name="editSchedule_testForm" method="post">
<input type="hidden" id="type" name="type" value="saveEditSchedule_test"/>
<input type="hidden" id="periodoId" name="periodoId" value="{$periodoId}"/>
<input type="hidden" id="scheduletestId" name="scheduletestId" value="{$post.scheduletestId}"/>
  ...
  <li>              
    <div class="content-in-popup">
      ...
      <div class="content-settings-row">
            ...
            <input name="comments" id="comments" type="text" value="{$post.comments}" size="60" maxlength="60"/>               
      </div>
            
      <div style="float:left"><span class="reqField">*</span> Campo requerido</div>
      <div style="padding-right:60px">                 
      <input type="button" class="btnCancel" style="margin-left:10px;" id="btnCancel" />
      <input type="button" class="btn-70-l" id="editSchedule_test" name="editSchedule_test" />                  
      </div>
