...
<ul id="sort-box" class="sorts">
  <li>
    <div class="content-in">
      ...
      <div class="content-settings-row">
      <input type="submit" class="btn-70-l" id="addStudent" name="addStudent" value="." />                  <a href="{$WEB_ROOT}/invoicesrep.php?invoiceId={$invoiceId}" target="_blank" title="Imprimir pagos" > <img src="{$WEB_ROOT}/images/icons/16/pdf.gif" class="spanPay" id="d-{$subject.invoiceId}" name="d-{$subject.name}"  /></a>
      </div>
