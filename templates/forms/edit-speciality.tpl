<form id="editSpecialityForm" name="editSpecialityForm" method="post">
<input type="hidden" id="type" name="type" value="saveEditSpeciality"/>
<input type="hidden" id="id" name="id" value="{$info.specialityId}" />
<ul id="sort-box" class="sorts">
  <li>              
    <div class="content-in-popup">
      ...
      <input type="button" class="btn-70-l" id="editSpeciality" name="editSpeciality" />                  
      </div>
