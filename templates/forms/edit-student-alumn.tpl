    ...
    <div class="content-in-popup">
      ...
      <div class="content-settings-row" align="center">
       ...
       <div class="content-settings-row">
            <label for="f1">
            <span style="position:relative;top:-50px">Cambiar Foto de Inicio</span>{$infoStudent.foto}</label>
...
<div class="content-settings-row">
            <label for="f1"><span class="reqField">*</span>Ocupaci&oacute;n:</label>
	 ...
	 <select id="estadot" name="estadot" style="width:300px" onChange="ciudad_dependenciat();" >
             <option value="0">Selecciona Tu Estado</option>
			     {foreach from=$estados item=estado}
     ...
     <div id="Citypositiont"> 
      ...
      <div class="content-settings-row">
            <label for="f1">Correo Electronico:</label>
