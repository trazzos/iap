  ...
  <li>              
    <div class="content-in-small">
      ...
      <div class="content-settings-row">
            ...
            <input type="text" name="name" id="name" value="{$resource.name}" style="width:150px" />         
      </div>

      <div class="content-settings-row">
            <label for="f1">Descripcion:</label>
            <input type="text" name="description" id="description" value="{$resource.description}" style="width:150px" />
      </div>
