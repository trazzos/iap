    ...
    <div class="content-in-popup">
      ...
      <div class="content-settings-row-register">
	       ...
	       <div class="content-settings-row-register">
			...
			<select id="pais" name="pais" style="width:350px" onChange="estado_dependencia();" >
      ...
      <div class="content-settings-row-register">
            ...
            <div id="Stateposition">
			 <select id="estado" name="estado" onChange='ciudad_dependencia();' style="width:350px">
	  ...
	  <div class="content-settings-row-register">
          ...
          <div id="Cityposition">  
			<select id="ciudad" name="ciudad" style="width:350px">
      ...
      <div class="content-settings-row-register">
            <label for="f1"><span class="reqField">*</span>Correo Electr&oacute;nico:</label>
...
<div class="content-settings-row-register">
      ...
      <div class="content-settings-row-register">
			...
			<select id="paist" name="paist" style="width:350px" onChange="estado_dependenciat();" >
             <option value="0">Selecciona Tu Pa&iacute;s</option>
			     {foreach from=$paises item=pais}
				 <option value="{$pais.paisId}">{$pais.nombre} </option>
				 {/foreach}
      ...
      <div class="content-settings-row-register">
            ...
            <div id="Statepositiont">
			 <select id="estadot" name="estadot" onChange='ciudad_dependenciat();' style="width:350px">
            <option value="0">Selecciona tu Estado</option>
        </select>                    
            </div>
	  ...
	  <div class="content-settings-row-register">
          ...
          <div id="Citypositiont">  
			<select id="ciudadt" name="ciudadt" style="width:350px">
            <option value="0">Selecciona tu Ciudad</option>
             </select>
	      </div>
	  </div>
 ...
 item{/foreach}
      ...
      <input type="button" class="btn-70-l" onclick="AddStudentRegister();" id="addStudent" name="addStudent" />                  
      </div>
