      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Código de Baja</div>
				<div id="vtitl"><span title="Titulo">Agregar Código de Baja</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-cancel-code.tpl"}
		</div>