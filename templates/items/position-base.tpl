{foreach from=$positions item=position}
    <tr>
        ...
        <td align="center">
            <img src="images/icons/16/delete.png" class="spanDelete" i id="d-{$position.positionId}" name="d-{$position.name}" title="Eliminar" />&nbsp;
          	<img src="images/icons/16/pencil.png" class="spanEdit" id="e-{$position.positionId}" name="e-{$position.name}" title="Editar" />
        </td>
    </tr>
{foreachelse}
	<tr>
